...
使用样例数据 `sensor_readings_with_anomalies.csv` 时，预期检测到以下异常：

| 异常类型 | 数量 | 说明 |
|---------|------|------|
| 重复上报 | 1 | PUMP-001 在 08:00:00 和 08:00:30 两次上报 |
| 水压突降 | 1 | PUMP-001 在 08:15-08:20 从 0.46 降到 0.25 (降幅 0.21) |
| 长时间离线 | 1 | PUMP-001 在 08:45-13:00 间隔 4小时15分 |
| 同时刻不同读数 | 2 | PUMP-002 在 08:15:00 有 0.51 和 0.60 两条记录 |
| 读数倒退 | 1 | PUMP-002 流量从 160.0 降到 155.5 再降到 145.0 |
